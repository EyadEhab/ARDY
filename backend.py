#!/usr/bin/env python3
"""
Flask backend API for ARDY Smart Agriculture
...
def generate_report():
    ...
    try:
        ...
        return send_file(
            ...
            as_attachment=True,
            download_name=f'ardy_report_{datetime.now().strftime("%Y%m%d_%H%M%S")}.pdf'
        )
    except Exception as e:
...
if __name__ == '__main__':
    print("Starting ARDY Smart Agriculture Backend Server...")
